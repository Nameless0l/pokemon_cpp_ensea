...
{
    if (!font.loadFromFile("assets/font/DejaVuSans.ttf") &&
        !font.loadFromFile("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf"))
    {
        throw std::runtime_error("Police introuvable : assets/font/DejaVuSans.ttf");
    }
}
...
const sf::Texture *SelectionScreen::textureFor(const Pokemon &pokemon)
{
    ...
    sf::Texture texture;
    if (!texture.loadFromFile("assets/image/pokemon/" + std::to_string(id) + ".png"))
    {
        return nullptr;
    }
...
{
    sf::RenderWindow window(sf::VideoMode(1000, 770), "Pokémon - Groupe d'attaque");
